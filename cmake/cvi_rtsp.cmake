...
elseif("${FILE_NAME}" MATCHES "riscv64-linux-gnu")
  set(RTSP_SDK_VER "glibc_riscv64")
elseif("${FILE_NAME}" MATCHES "riscv64-unknown-linux-gnu")
  set(RTSP_SDK_VER "glibc_riscv64")
elseif("${FILE_NAME}" MATCHES "riscv64-unknown-linux-musl")
  set(RTSP_SDK_VER "musl_riscv64")
else()
...
set(RTSP_SOURCE_DIR ${SOURCE_DIR})
...
set(CVI_RTSP_LIB_SHARED ${RTSP_SOURCE_DIR}/src/libcvi_rtsp.so)
set(CVI_RTSP_LIB_STATIC ${RTSP_SOURCE_DIR}/src/libcvi_rtsp.a
...
set(CVI_RTSP_INCLUDE ${RTSP_SOURCE_DIR}/include/cvi_rtsp)

message(STATUS "CVI_RTSP_LIB_SHARED: ${CVI_RTSP_LIB_SHARED}")
